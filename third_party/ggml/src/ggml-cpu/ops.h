...
void ggml_compute_forward_im2col_rafa(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_snake_1d(const struct ggml_compute_params * params, struct ggml_tensor * dst);
