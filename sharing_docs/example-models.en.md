...
The repo ports three small models (two TTS, one OCR) using
...
Python in [`example/python/higgstts_py/`](../example/python/higgstts_py/), C# in
...
([`example/python/ocr_py/`](../example/python/ocr_py/)), self-contained `.pyd`. A cropped line (or
