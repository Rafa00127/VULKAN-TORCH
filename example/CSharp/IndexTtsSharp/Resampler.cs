...
/// (e.g. 44.1k/24k -> 16k/22.05k). Replaces the earlier hand-rolled Kaiser resampler,
/// which had a wrong cutoff + gain and mis-registered polyphase taps, producing
/// near-silent output on large upsample factors and audible distortion elsewhere
/// (this is what made the reference mel/features garbage and the audio "explode").
/// </summary>
